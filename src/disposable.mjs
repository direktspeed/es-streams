/**
 * This exports some standard Disposables and Operators for disposeables
 */
...
export const tryDisposeErrorToSink = curry3((t, disposable, sink) => {
    try {
        disposable.dispose();
    }
    catch (e) {
...
export { DisposeAllError, dispose, disposeAll, disposeBoth, disposeNone, disposeOnce, disposeWith, isDisposeNone};
