...
export const attach = curry2(__attach);
function __attach(sink, stream) {
    return sink.attach(stream);
}

export class ProxyStream extends MulticastSource {
    constructor() {
        super(never());
        this.attached = false;
        this.running = false;
